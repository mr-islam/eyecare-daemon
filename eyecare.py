...
# subprocess is preferred, but try 'os.system' if you encounter an `OSError`
...
if os1 == 'linux':
    ...
    while command_method == 'os.system':
...
if os1 == 'darwin':  # thats osx
    ...
    command_method = 'os.system'
    # default for osx, because osx users so far have enocuntered the error mentioned in line 26. please comment out this line if your python path variable is set.
